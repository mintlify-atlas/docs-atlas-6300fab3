...
The logout button is accessible from the user dropdown menu in the application header.

You can also use the auth store's logout action for programmatic logout:
